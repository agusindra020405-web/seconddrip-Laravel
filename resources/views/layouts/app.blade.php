                ...
                <div class="flex items-center gap-6">
                    ...
                    <button class="relative hover:text-emerald-400 transition text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor" class="w-5 h-5">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M15.75 10.5V6a3.75 3.75 0 1 0-7.5 0v4.5m11.356-1.993 1.115 10.033a2.25 2.25 0 0 1-2.243 2.493H5.282a2.25 2.25 0 0 1-2.243-2.493L4.154 8.507a2.25 2.25 0 0 1 2.243-2.493h11.214a2.25 2.25 0 0 1 2.243 2.493Z" />
                        </svg>
                        <span
                            class="absolute -top-2 -right-2 bg-emerald-500 text-[9px] text-black font-bold px-1.5 py-0.5 rounded-full">0</span>
                    </button>
