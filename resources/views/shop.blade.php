        ...
        <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
            ...
            @forelse($products as $product)
                <a href="{{ route('shop.detail', $product->id) }}" class="group">
                    <!-- CARD -->
                    <div
                        class="bg-gray-900 border border-gray-800 rounded-lg overflow-hidden group hover:-translate-y-2 hover:shadow-2xl transition duration-300">
                        ...
                        <div class="h-64 flex items-center justify-center bg-gray-950 overflow-hidden">
                            ...
                            @else
                                ...
                                <img src="{{ asset('images/logo.png') }}" alt="Default Logo" class="w-24 opacity-50">
                            @endif
